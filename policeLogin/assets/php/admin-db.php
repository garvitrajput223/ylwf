<?php 
	...
	class Admin extends Database
	{
		...
		public function admin_login($username, $password){
			$sql = "SELECT * FROM police_stations_users JOIN police_stations ON police_stations_users.police_station_id = police_stations.id WHERE username = :username AND password = :password";
