					...
					<div class="login-right">
						<div class="login-right-wrap">
							...
							<form action="#" method="post" id="register-form">
								...
								<div class="form-group">
									<p style="line-height:0; font-size:15px; color:red">Enter Aadhaar Card Number</p>
									<input class="form-control" name="uid" id="uid" type="text" placeholder="Aadhaar Number" onkeyup="addHyphen(this)" onfocusout="validateAadhaar()" required>
								</div>
								<div class="form-group">
									<input class="form-control" name="mobile" id="mobile_number" type="number" placeholder="Mobile Number" onfocusout="validateMobile()" required>
								</div>
								<div class="form-group">
